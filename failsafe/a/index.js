...
//ChatMessageField--------------------------------------
//======================================================
class BetterMessage2 extends React.Component{
    constructor(props){
        super(props)
        this.state = {
            propz: this.props.messages
        }
    }

    render(){
        const { propz } = this.state;
        return(
            <div>
                <ul className='chat-list'>
                {
                    console.log(this.state.propz)
                   propz.map((item,index) => {
    ...
    render(){
        return(
            <div className='flex-column'>
                <div className='flex-column'>
                    <BetterMessage2 messages= {this.state.chat}/>
                </div>
